...
@Path("/admin/orders")
@RequestScoped
public class ListUserReceivedOrderController extends CurrentUserAwareController {
    ...
    public Response listAction(@PathParam("id") Integer userId) throws NotFoundException {
        ...
        List<Order> orders = this.orderRepository.findByRecipient(userById);
